...
export const Impact = () => {
  return (
    <section id="impact" className="container py-20 md:py-28">
      <div className="rounded-3xl overflow-hidden bg-gradient-festival p-8 md:p-14 text-primary-foreground shadow-warm relative">
        ...
        <div className="relative max-w-2xl">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-2">Heritage. Livelihood. Legacy.</h2>
        ...
        <div className="relative grid md:grid-cols-3 gap-5 mt-10">
          {goals.map((g) => (
